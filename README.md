...
### Вопросы и ответы, решение пробелем
* 1) В функциях которые `async` не ловяться ошибки, как их словить ?
* 2) Как проверить свойство обьекта на пустоту или `undefined`?
* 3) Упрощение тернарного (?:) оператора.
* 4) [Как сделать JS более производительным?](https://medium.com/devschacht/3-tips-about-javascript-597c33a219d6)
